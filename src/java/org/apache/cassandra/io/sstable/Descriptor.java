...
public class Descriptor
{
    ...
    // hd (1.0.4): records estimated # of expiring columns in metadata component
    ...
    public final boolean hasExpiringColumnCount;
    ...
    public Descriptor(String version, File directory, String ksname, String cfname, int generation, boolean temp)
    {
        ...
        hasExpiringColumnCount = version.compareTo("hd") >= 0;
