...
public class DebuggableThreadPoolExecutor extends ThreadPoolExecutor
{
    ...
    {
        return new DebuggableThreadPoolExecutor(size, Integer.MAX_VALUE, keepAliveTime, unit, new BlockingArrayQueue<Runnable>(), new NamedThreadFactory(threadPoolName));
    }
