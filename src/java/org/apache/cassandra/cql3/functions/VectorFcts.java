...
public abstract class VectorFcts
{
    ...
    public static final NativeScalarFunction cosine_similarity = new NativeScalarFunction("cosine_similarity", VectorType.instance, VectorType.instance)
    {
    };

    public static NativeScalarFunction cosine_similarity(VectorType a, VectorType b)
    {
