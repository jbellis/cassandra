...
If an @IF@ condition is specified, a special boolean @[applied]@ column will be included the resultset, indicating success or failure of the operation.  On failure, the current columns from the @IF@ condition will also be included.
