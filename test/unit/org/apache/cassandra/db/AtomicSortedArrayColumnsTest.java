...
public class AtomicSortedArrayColumnsTest extends SchemaLoader
{
    @Test
    public void testAdd()
    {
...
//        testAddInternal(true);
    ...
    {
        ColumnFamily map = AtomicSortedArrayColumns.factory.create(metadata(), reversed);
...
//        testAddAllInternal(true);
    ...
    {
        ColumnFamily map = AtomicSortedArrayColumns.factory.create(metadata(), reversed);
        ColumnFamily map2 = AtomicSortedArrayColumns.factory.create(metadata(), reversed);
